...
var Dashboard = React.createClass({
  ...
  getInitialState() {
    ...
    var yearOfLastRecord = moment(records[records.length-1].date).year()
    return _.merge({ recordsByYear }, this.getRecordsOfYear(yearOfLastRecord, recordsByYear[yearOfLastRecord]))
  },
  ...
  render() {
    var { total, latest, year } = this.state
    return (
